    ...
    <div className="app-page">
      ...
      <div className="content">
        <Routes>
          ...
          />
          <Route
            path="/custom-superhero/:id"
            element={<CustomSuperHero setNewSuperheroes={setNewSuperheroes} />}
          />
          <Route
            path="/create-superhero"
            element={<CreateSuperHero setNewSuperheroes={setNewSuperheroes} />}
          />
          <Route path="/superhero-details/:id" element={<SuperHeroDetails />} />
          <Route
            path="/custom-superhero-details/:id"
            element={
              <CustomSuperHeroDetails
                newSuperheroes={newSuperheroes}
                setNewSuperheroes={setNewSuperheroes}
              />
            }
          ...
          <Route
            path="/comics-page"
            element={<ComicsPage comics={comics} setComics={setComics} />}
          />
